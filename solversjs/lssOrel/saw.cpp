...
void SAW::printResults() {
	...
	if(walkLengthFactor != 0) cout<<setw(w)<<"walkSegmCoef"<<setprecision(2)<<walkLengthFactor<<setprecision(6)<<endl;
	else cout<<setw(w)<<"walkSegmCoef "<<"NA"<<endl;
